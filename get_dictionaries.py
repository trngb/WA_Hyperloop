...
def get_sheet4_6_classes(version = 'litani_1'):
    ...
    'Forests':              [1,8,9,10,11],
    'Shrubland':            [2,14],
    'Rainfed Crops':        [34,35,36,37,39,40,41],
    'Forest Plantations':   [33,44],
    'Natural Water Bodies': [23],
    'Wetlands':             [5,30],
    'Natural Grasslands':   [3,16],
    'Other (Non-Manmade)':  [7,21,27,45,46,47,48,49,50,51],
    'Irrigated crops':      [53,54,55,56,58,59,60],
    'Managed water bodies': [63],
    'Aquaculture':          [65],
    'Residential':          [72],
    'Greenhouses':          [64],
    'Other':                [53,67,73,75,76]}
    ...
    'Greenhouses':          [64],
    'Other':                [68,69,70,71,76,78,63,74,75,77]}
